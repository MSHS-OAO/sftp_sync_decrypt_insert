...
repdef_data <- tbl(con_prod, in_schema("LENANG01", "LPM_MAPPING_REPDEF")) %>%
  collect() %>%
  ...
  mutate(DEFINITION_CODE = replace_na(DEFINITION_CODE, ""),
         ...
         #,
         #DEFINITION_CODE = gsub("*", "'|| chr(42) ||'", COST_CENTER_DESCRIPTION)
         )
...
tryCatch({
  ...
  print("LPM_MAPPING_REPDEF has been truncated")
  dbCommit(con_prod)
...
registerDoSEQ()
print(paste(repdef_table, "has been updated"))
