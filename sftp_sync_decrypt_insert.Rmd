...
costcenter_merge <- glue(
  "MERGE INTO LPM_TEST_MAPPING_COST_CENTER destination
   USING OAO_DEVELOPMENT.LPM_TEST_MAPPING_COST_CENTER source
   ...
   WHEN NOT MATCHED THEN
   INSERT (destination.LEGACY_COST_CENTER,
           destination.COST_CENTER_DESCRIPTION,
           destination.DEFINITION_CODE)
   VALUES (source.LEGACY_COST_CENTER,
...
repdef_merge <- glue(
  "MERGE INTO LPM_TEST_MAPPING_REPDEF destination
   USING OAO_DEVELOPMENT.LPM_TEST_MAPPING_REPDEF source
...
# merge statement for reporting definition mapping table
keyvol_merge <- glue(
  "MERGE INTO LPM_TEST_MAPPING_KEY_VOLUME destination
   USING OAO_DEVELOPMENT.LPM_TEST_MAPPING_KEY_VOLUME source
   ...
   WHEN NOT MATCHED THEN
   INSERT (destination.CLOSED)
   VALUES (source.CLOSED);"
)
# end ###########################################################################
